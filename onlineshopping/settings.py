...
SECRET_KEY = '-jtrkfumw2vbp3az@)t5vn!74l)rr#79*a%rwk&42%uhme26y9'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
				...
				'shoppingsite.context_processors.category_list',
				'cart.context_processors.cart',
				
            ],
			'libraries':{
				'filter_tags':'shoppingsite.templatetags.filter',
			}
        },
    },
]
...
LOGIN_REDIRECT_URL='/design1/'
LOGOUT_REDIRECT_URL='/design1/'